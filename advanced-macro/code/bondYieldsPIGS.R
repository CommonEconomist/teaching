# Bond yields PIGS (Germany as reference)
par(mar=c(5,5,3,2),bty='n',las=1,cex.axis=2,cex.lab=2,cex.main=2)
bonds<-read.csv("data/eurostat-bond-yields.csv",header=TRUE)
...
germany<-ts(bonds[
  bonds$GEO=="Germany (until 1990 former territory of the FRG)",]$Value,
